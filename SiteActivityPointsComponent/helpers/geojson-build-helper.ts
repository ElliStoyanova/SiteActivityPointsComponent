...
export function generateGeoJson(coordinates: { latitude: number; longitude: number; properties: GeoJsonProperties }[]): FeatureCollection<Geometry, GeoJsonProperties> {
