import { FeatureCollection, GeoJsonProperties, Geometry, GeometryCollection, LineString, MultiLineString, MultiPoint, MultiPolygon, Point, Polygon, Position } from "geojson";
    ...
    geojson.features.forEach(feature => {
        if (feature.geometry && (feature.geometry as any).coordinates) {
            if (feature.geometry.type === 'Point') {
                ...
                // Handle LineString and Polygon coordinates
